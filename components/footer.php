...
<!-- <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="tel:5280165"><i class="fas fa-phone"></i> 5280165</a>
         <a href="mailto:kiranmdhr9@gmail.com"><i class="fas fa-envelope"></i> kiranmdhr9@gmail.com</a>
         <a href="mailto:romitmanandhar@gmail.com"><i class="fas fa-envelope"></i> romitmanandhar@gmail.com</a>
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="bookings.php" class="text-reset">My Bookings</a>
          </p>
          <p>
            <a href="index.php#reservation" class="text-reset">Reservation</a>
          </p>
          <p>
            <a href="index.php#reviews" class="text-reset">Reviews</a>
          </p>
          <p>
            <a href="index.php#contact" class="text-reset">Contact Us</a>
          </p>
        </div>
        <!-- Grid column -->
